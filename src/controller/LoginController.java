...
/**
 * Bu class oturum açma işlemlerini yönetir
 */
public class LoginController {
    ...
    /**
     * Oturum açma butonunu kontrol eder
     * Kullanıcının girdiği verileri alır ve gerekli doğrulamaları yapar
     * Bilgiler doğru ise yeni bir UserSessionController örneği oluşturur
     */
    ...
    /**
     * Kullanıcıyı kayıt ekranı sayfasına yönlendirir
     */
